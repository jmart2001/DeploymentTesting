...
// Read the JSON file
const rawData = fs.readFileSync('chicken_recipies.json');
...
fs.writeFileSync('modified_chicken_recipes.json', modifiedRecipesJSON);

console.log('Modified recipes have been saved to modified_recipes.json');
=======
import fs from 'fs';
