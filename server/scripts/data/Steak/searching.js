...
// Read the JSON file
const rawData = fs.readFileSync('steak_recipes.json');
...
fs.writeFileSync('modified_steak_recipes.json', modifiedRecipesJSON);

console.log('Modified recipes have been saved to modified_steak_recipes.json');
=======
import fs from 'fs';
