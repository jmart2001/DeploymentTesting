...
const searchTerm = 'cornstarch'; // Replace with your desired search term
...
async function fetchAndWriteKrogerProductData() {
  try {
    ...
    await writeFile('cornstarch_prices.json', JSON.stringify({ data: processedData }, null, 2));
    console.log('Processed product data written to cornstarch_prices.json');
