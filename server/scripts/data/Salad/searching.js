...
// Read the JSON file
const rawData = fs.readFileSync('salad_recipies.json');
...
fs.writeFileSync('modified_salad_recipes.json', modifiedRecipesJSON);

console.log('Modified recipes have been saved to modified_salad_recipes.json');
=======
import fs from 'fs';
...
console.log('Modified recipes have been saved to modified_salad_recipes.json');
>>>>>>> 297f26138db94fb0a1e2dcacedd50018aa4707a9
